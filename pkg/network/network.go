...
type AddressDerivationFunc func(curves.Point, Network) (string, error)
...
func VerifySignature(point curves.Point, network Network, txOrigin []byte, signature []byte) (bool, error) {
	handler, exists := networkHandlerMap[network]
	if !exists {
