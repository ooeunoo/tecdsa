...
type Output interface {
	GetPublicKey() curves.Point
	GetSecretKeyShare() curves.Scalar
	GetSeedOtResult() interface{}
}

type AliceOutputWrapper struct {
	*dkg.AliceOutput
}

type BobOutputWrapper struct {
	*dkg.BobOutput
}

func (ao AliceOutputWrapper) GetPublicKey() curves.Point       { return ao.PublicKey }
func (ao AliceOutputWrapper) GetSecretKeyShare() curves.Scalar { return ao.SecretKeyShare }
func (ao AliceOutputWrapper) GetSeedOtResult() interface{}     { return ao.SeedOtResult }

func (bo BobOutputWrapper) GetPublicKey() curves.Point       { return bo.PublicKey }
func (bo BobOutputWrapper) GetSecretKeyShare() curves.Scalar { return bo.SecretKeyShare }
func (bo BobOutputWrapper) GetSeedOtResult() interface{}     { return bo.SeedOtResult }
...
// func (ao *AliceOutput) GetPublicKey() curves.Point       { return ao.PublicKey }
// func (ao *AliceOutput) GetSecretKeyShare() curves.Scalar { return ao.SecretKeyShare }
// func (ao *AliceOutput) GetSeedOtResult() interface{}     { return ao.SeedOtResult }

// func (bo *BobOutput) GetPublicKey() curves.Point       { return bo.PublicKey }
// func (bo *BobOutput) GetSecretKeyShare() curves.Scalar { return bo.SecretKeyShare }
// func (bo *BobOutput) GetSeedOtResult() interface{}     { return bo.SeedOtResult }
